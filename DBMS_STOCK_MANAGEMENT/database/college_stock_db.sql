...
DROP TABLE IF EXISTS pdf_export_logs, excel_import_logs, notifications, login_history, activity_logs, stock_book, invoices, approvals, request_items, requests, stock_transactions, items, categories, users, departments;
...
CREATE TABLE users (
  ...
  role ENUM('ADMIN','PRINCIPAL','DEPARTMENT') NOT NULL,
...
CREATE TABLE items (
  ...
  deletion_approval_status ENUM('NOT_REQUESTED','PENDING_PRINCIPAL','APPROVED_BY_PRINCIPAL','REJECTED_BY_PRINCIPAL') NOT NULL DEFAULT 'NOT_REQUESTED',
...
CREATE TABLE requests (
  ...
  status ENUM('PENDING_PRINCIPAL','APPROVED_BY_PRINCIPAL','REJECTED_BY_PRINCIPAL','ISSUED','PARTIALLY_ISSUED') NOT NULL DEFAULT 'PENDING_PRINCIPAL',
  principal_remarks TEXT NULL,
  principal_approved_by INT NULL,
  principal_approved_at DATETIME NULL,
...
CREATE TABLE approvals (
  ...
  role ENUM('PRINCIPAL','ADMIN') NOT NULL,
...
(NULL, 'System Admin', 'admin@college.test', '$2y$10$pzPy3XX7zXIj8sB4lx2BVefK9hHGmMPnMFqXlcuYWAA9OndlOeg4a', 'ADMIN'),
(NULL, 'Principal', 'principal@college.test', '$2y$10$pzPy3XX7zXIj8sB4lx2BVefK9hHGmMPnMFqXlcuYWAA9OndlOeg4a', 'PRINCIPAL'),
