...
<div class="card metric-card"><div class="table-responsive"><table class="table mb-0"><thead><tr><th>No</th><th>Date</th><th>Purpose</th><th>Status</th><th>PDF</th></tr></thead><tbody><?php foreach($requests as $r): ?><tr><td><?= e($r['request_no']) ?></td><td><?= e($r['created_at']) ?></td><td><?= e($r['purpose']) ?></td><td><span class="badge text-bg-secondary"><?= e($r['status']) ?></span></td><td><a class="btn btn-sm btn-outline-primary" href="<?= BASE_URL ?>/download_pdf.php?type=request&id=<?= $r['id'] ?>"><i class="bi bi-file-pdf"></i></a></td></tr><?php endforeach; ?></tbody></table></div></div>
<?php render_footer(); ?>
